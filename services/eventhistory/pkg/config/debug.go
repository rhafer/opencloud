...
type Debug struct {
	...
	Disabled bool   `yaml:"disabled" env:"EVENTHISTORY_DEBUG_DISABLED" desc:"Disables the debug server, including the /metrics, /healthz and /readyz endpoints." introductionVersion:"4.0.0"`
}
